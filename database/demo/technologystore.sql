...
INSERT INTO `ct_bao_hanh` (`id_bh`, `seri`)
VALUES ('BH000001', 'SERI0000700010'),
...
INSERT INTO `ct_hoa_don` (`id_hoadon`, `seri`, `don_gia`)
VALUES ('HD29112024000001', 'SERI0000300001', 50000),
...
INSERT INTO `ct_nhap_kho` (`id_pn`, `seri`, `cost`)
VALUES ('PN000001', 'SERI0000300001', 40000),
...
INSERT INTO `ct_san_pham` (`seri`, `id_sp`, `color`, `price`, `isDelete`)
VALUES ('SERI0000200001', 'PRODUCT00002', 'Cam', 25000, 0),
...
INSERT INTO `hoa_don` (`id`, `ngaylap`, `order_amount`, `discount_amount`, `ghichu`, `km`, `pttt`, `id_khachhang`,
                       `id_nhanvien`, `isDelete`)
VALUES ('HD29112024000001', '2024-11-29 04:44:49', 260000, 0, NULL, NULL, NULL, 'CUSTOMER00007', 'STAFF00001', 0);
...
INSERT INTO `khach_hang` (`id`, `name`, `phone`, `address`, `district`, `ward`, `city`, `isDelete`)
VALUES ('CUSTOMER00001', 'Hải Dương', '0868707528', '125 Nguyễn Thị Tần', 'Quận 8', 'Phường 01',
        'Thành phố Hồ Chí Minh', 0),
       ('CUSTOMER00002', 'Trần Hữu Nghĩa', '0125874662', '25 Nguyễn Trực', 'Quận 8', 'Phường 01',
        'Thành phố Hồ Chí Minh', 0),
       ('CUSTOMER00003', 'Tiến Toàn', '0905286214', '147 Dương Bá Trạc', 'Quận 8', 'Phường 02', 'Thành phố Hồ Chí Minh',
        1),
       ('CUSTOMER00004', 'Anh Thư', '0907530625', '789 Phạm Hữu Lầu', 'Quận 7', 'Phường Phú Thuận',
        'Thành phố Hồ Chí Minh', 0),
       ('CUSTOMER00005', 'Duong Domic', '0868707527', '45 Dong Da', 'Huyện Ba Vì', 'Xã Ba Vì', 'Thành phố Hà Nội', 0),
       ('CUSTOMER00006', 'Duong', '0868707456', '145 Nguyen Thi Tan', 'Vui lòng chọn Tỉnh/Thành phố',
        'Vui lòng chọn Quận/Huyện', 'Chọn Tỉnh/Thành phố', 1),
       ('CUSTOMER00007', 'Gia Liêm', '0907560528', '789 Ấp Kênh Kháng Chiến', 'Thị xã Cai Lậy', 'Xã Tân Bình',
        'Tỉnh Tiền Giang', 0),
       ('CUSTOMER00008', 'Nhu Quynh', '0868737528', '78 Nguyen Du', 'Quận 8', 'Phường 01', 'Thành phố Hồ Chí Minh', 0),
       ('CUSTOMER00009', 'Gia Lao', '0907530962', '784/78 Nguyen Thi Dinh', 'Quận Tân Bình', 'Phường 03',
        'Thành phố Hồ Chí Minh', 1),
       ('CUSTOMER00010', 'Huu Nghia', '0127452215', '125/744 Nguyen Thi Tan', 'Quận 8', 'Phường 01',
        'Thành phố Hồ Chí Minh', 0),
       ('CUSTOMER00011', 'Duong Domic', '0868752521', '75 Bui Thi Xuan', 'Quận 1', 'Phường Cô Giang',
        'Thành phố Hồ Chí Minh', 0),
       ('CUSTOMER00012', 'Nguyen Thanh Sang', '0123547855', '74 An Lac', 'Huyện An Lão', 'Thị trấn Trường Sơn',
        'Thành phố Hải Phòng', 0),
       ('CUSTOMER00013', 'Tri Son', '0907530964', 'Chung cu Phong Xich Lam', 'Huyện Bình Chánh', 'Xã An Phú Tây',
        'Thành phố Hồ Chí Minh', 0),
       ('CUSTOMER00014', 'Hung', '0905263456', 'Chung Cu Phu My', 'Huyện Thanh Oai', 'Thị trấn Kim Bài',
        'Thành phố Hà Nội', 0);
...
INSERT INTO `khuyen_mai` (`id`, `name`, `discount_percent`, `min_order`, `startDate`, `endDate`, `status`, `isDelete`)
VALUES ('KM01', 'Thang 11', 30, 0, '2024-11-27 00:00:00', '2024-11-30 00:00:00', 'Chưa bắt đầu', 0);
...
INSERT INTO `ncc` (`id`, `name`, `phone`, `isDelete`, `address`, `ward`, `district`, `city`)
VALUES ('NCC0001', 'Apple', '0907530962', 0, '789 Dương Bá Trạc', 'Phường Bến Thành', 'Quận 1',
...
VALUES ('STAFF00001', 'Huỳnh Ngọc Hải Dương', '0868707529', 1, '2004-09-22', 'duonghuynh2209@gmail.com', 0),
...
INSERT INTO `option_san_pham` (`id_sp`, `color`, `isDelete`)
VALUES ('PRODUCT00002', 'Cam', 0),
       ('PRODUCT00002', 'Hồng', 0),
...
INSERT INTO `phan_loai` (`id`, `name`, `isDelete`)
VALUES ('CATE001', 'Điện Thoại', 0),
       ('CATE002', 'Laptop', 0),
       ('CATE003', 'Tủ Lạnh', 0);
...
INSERT INTO `phieu_bao_hanh` (`id`, `ngaybaohanh`, `id_nhanvien`, `id_hoadon`, `ngaytrahang`, `isDelete`)
VALUES ('BH000001', '2024-12-05 23:54:35', 'STAFF00001', 'HD29112024000001', '2024-12-06', 0);
...
INSERT INTO `phieu_nhap_kho` (`id`, `ngaynhap`, `total`, `id_nhanvien`, `id_ncc`, `isDelete`)
VALUES ('PN000001', '2024-11-27 02:39:49', 300000, 'STAFF00001', 'NCC0001', 0),
...
INSERT INTO `san_pham` (`id`, `name`, `isDelete`, `id_cate`, `baohanh`, `img`)
VALUES ('PRODUCT00001', 'Samsung', 1, 'CATE001', 4, ''),
...
VALUES ('duongdonate', 'HD12345678', 'STAFF00001', 'POS001', 0),
...
CREATE ALGORITHM = UNDEFINED DEFINER =`root`@`localhost` SQL SECURITY DEFINER VIEW `baohanh_nv_kh` AS
SELECT `pbh`.`id`          AS `id`,
       `pbh`.`ngaybaohanh` AS `ngaybaohanh`,
       `pbh`.`id_nhanvien` AS `id_nhanvien`,
       `pbh`.`id_hoadon`   AS `id_hoadon`,
       `pbh`.`ngaytrahang` AS `ngaytrahang`,
       `nv`.`name`         AS `name_nhanvien`,
       `hd`.`id_khachhang` AS `id_khachhang`,
       `kh`.`name`         AS `name_khachhang`,
       `pbh`.`isDelete`    AS `isDelete`
FROM (((`phieu_bao_hanh` `pbh` left join `nhan_vien` `nv` on (`nv`.`id` = `pbh`.`id_nhanvien`)) left join `hoa_don` `hd`
       on (`pbh`.`id_hoadon` = `hd`.`id`)) left join `khach_hang` `kh` on (`hd`.`id_khachhang` = `kh`.`id`));
...
CREATE ALGORITHM = UNDEFINED DEFINER =`root`@`localhost` SQL SECURITY DEFINER VIEW `chitietbaohanh` AS
SELECT `ctbh`.`id_bh` AS `id_bh`, `ctbh`.`seri` AS `seri`, `csp`.`id_sp` AS `id_sp`, `csp`.`color` AS `color`
FROM (`ct_bao_hanh` `ctbh` left join `ct_san_pham` `csp` on (`csp`.`seri` = `ctbh`.`seri`));
...
CREATE ALGORITHM = UNDEFINED DEFINER =`root`@`localhost` SQL SECURITY DEFINER VIEW `chitietsanpham` AS
SELECT `ctsp`.`seri`     AS `seri`,
       `ctsp`.`id_sp`    AS `id_sp`,
       `ctsp`.`color`    AS `color`,
       `ctsp`.`price`    AS `price`,
       `ctsp`.`isDelete` AS `isDelete`,
       `chd`.`id_hoadon` AS `id_hoadon`,
       `cnk`.`id_pn`     AS `id_pn`,
       `cnk`.`cost`      AS `cost`,
       `pnk`.`ngaynhap`  AS `ngaynhap`,
       `hd`.`ngaylap`    AS `ngaylap`
FROM ((((`ct_san_pham` `ctsp` left join `ct_hoa_don` `chd`
         on (`ctsp`.`seri` = `chd`.`seri`)) left join `ct_nhap_kho` `cnk`
        on (`ctsp`.`seri` = `cnk`.`seri`)) left join `phieu_nhap_kho` `pnk`
       on (`cnk`.`id_pn` = `pnk`.`id`)) left join `hoa_don` `hd` on (`chd`.`id_hoadon` = `hd`.`id`));
...
CREATE ALGORITHM = UNDEFINED DEFINER =`root`@`localhost` SQL SECURITY DEFINER VIEW `hoadon_nv_kh` AS
SELECT `hd`.`id`              AS `id`,
       `hd`.`ngaylap`         AS `ngaylap`,
       `hd`.`order_amount`    AS `order_amount`,
       `hd`.`discount_amount` AS `discount_amount`,
       `hd`.`km`              AS `km`,
       `hd`.`pttt`            AS `pttt`,
       `hd`.`id_khachhang`    AS `id_khachhang`,
       `hd`.`id_nhanvien`     AS `id_nhanvien`,
       `hd`.`isDelete`        AS `isDelete`,
       `nv`.`name`            AS `name_nhanvien`,
       `kh`.`name`            AS `name_khachhang`,
       `p`.`name`             AS `name_pttt`
FROM (((`hoa_don` `hd` left join `nhan_vien` `nv` on (`hd`.`id_nhanvien` = `nv`.`id`)) left join `khach_hang` `kh`
       on (`kh`.`id` = `hd`.`id_khachhang`)) left join `pttt` `p` on (`hd`.`pttt` = `p`.`id`));
...
CREATE ALGORITHM = UNDEFINED DEFINER =`root`@`localhost` SQL SECURITY DEFINER VIEW `nhanvien_username` AS
SELECT `nv`.`id`       AS `id`,
       `nv`.`name`     AS `name`,
       `nv`.`phone`    AS `phone`,
       `nv`.`gender`   AS `gender`,
       `nv`.`birth`    AS `birth`,
       `nv`.`email`    AS `email`,
       `nv`.`isDelete` AS `isDelete`,
       `tk`.`username` AS `username`
FROM (`nhan_vien` `nv` left join `tai_khoan` `tk` on (`nv`.`id` = `tk`.`id_nhanvien`))
WHERE `nv`.`isDelete` = 0;
...
CREATE ALGORITHM = UNDEFINED DEFINER =`root`@`localhost` SQL SECURITY DEFINER VIEW `permission` AS
SELECT `q`.`name`                                      AS `Tên quyền`,
       `cn`.`name`                                     AS `Tên chức năng`,
       group_concat(`ctq`.`permission` separator ', ') AS `Các hành động`
FROM ((`ct_quyen` `ctq` left join `chuc_nang` `cn` on (`cn`.`id` = `ctq`.`id_chucnang`)) left join `quyen` `q`
      on (`ctq`.`id_quyen` = `q`.`id`))
GROUP BY `ctq`.`id_quyen`, `ctq`.`id_chucnang`;
...
CREATE ALGORITHM = UNDEFINED DEFINER =`root`@`localhost` SQL SECURITY DEFINER VIEW `phieunhap_nv_ncc` AS
SELECT `pnk`.`id`          AS `id`,
       `pnk`.`ngaynhap`    AS `ngaynhap`,
       `pnk`.`total`       AS `total`,
       `pnk`.`id_nhanvien` AS `id_nhanvien`,
       `pnk`.`id_ncc`      AS `id_ncc`,
       `pnk`.`isDelete`    AS `isDelete`,
       `nv`.`name`         AS `name_nhanvien`,
       `ncc`.`name`        AS `name_ncc`
FROM ((`phieu_nhap_kho` `pnk` left join `nhan_vien` `nv` on (`pnk`.`id_nhanvien` = `nv`.`id`)) left join `ncc`
      on (`pnk`.`id_ncc` = `ncc`.`id`));
...
CREATE ALGORITHM = UNDEFINED DEFINER =`root`@`localhost` SQL SECURITY DEFINER VIEW `sanpham_count` AS
SELECT `sp`.`id`                                                                    AS `id`,
       `sp`.`name`                                                                  AS `name`,
       (select count(0) from `ct_san_pham` `ctsp` where `ctsp`.`id_sp` = `sp`.`id`) AS `tonkho`,
       `sp`.`id_cate`                                                               AS `id_cate`,
       `pl`.`name`                                                                  AS `name_cate`,
       `sp`.`baohanh`                                                               AS `baohanh`,
       `sp`.`img`                                                                   AS `img`
FROM (`san_pham` `sp` left join `phan_loai` `pl` on (`sp`.`id_cate` = `pl`.`id`))
WHERE `sp`.`isDelete` = 0
  AND `pl`.`isDelete` = 0;
...
CREATE ALGORITHM = UNDEFINED DEFINER =`root`@`localhost` SQL SECURITY DEFINER VIEW `taikhoan_email` AS
SELECT `tk`.`username`    AS `username`,
       `tk`.`password`    AS `password`,
       `tk`.`id_quyen`    AS `id_quyen`,
       `tk`.`id_nhanvien` AS `id_nhanvien`,
       `nv`.`email`       AS `email`,
       `q`.`name`         AS `name_quyen`,
       `tk`.`isDelete`    AS `trangthai`
FROM ((`tai_khoan` `tk` left join `nhan_vien` `nv` on (`tk`.`id_nhanvien` = `nv`.`id`)) left join `quyen` `q`
      on (`tk`.`id_quyen` = `q`.`id`))
WHERE `q`.`isDelete` = 0
  AND `nv`.`isDelete` = 0;

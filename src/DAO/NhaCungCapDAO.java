...
public class NhaCungCapDAO extends ObjectDAO {
    ...
    public void updateNhaCungCap(NhaCungCapDTO nhaCungCap) {
        ...
        Object[] params = {nhaCungCap.getName(), nhaCungCap.getPhone(), nhaCungCap.getAddress(), nhaCungCap.getWard(), nhaCungCap.getDistrict(), nhaCungCap.getCity(), nhaCungCap.getId()};
        super.executeNonQuery(query, params);
    }

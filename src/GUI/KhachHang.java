...
public class KhachHang extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        soNhaTextField.setBorder(new FlatLineBorder(new Insets(3, 3, 3, 3), new Color(0, 0, 0), 1, 15));
        ...
        phuongTextField.setBorder(new FlatLineBorder(new Insets(3, 3, 3, 3), new Color(0, 0, 0), 1, 15));
        ...
        quanTextField.setBorder(new FlatLineBorder(new Insets(3, 3, 3, 3), new Color(0, 0, 0), 1, 15));
        ...
        thanhPhoTextField.setBorder(new FlatLineBorder(new Insets(3, 3, 3, 3), new Color(0, 0, 0), 1, 15));

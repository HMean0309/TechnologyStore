...
//        this.setBorder(new EmptyBorder(0, 10, 5, 10));
    ...
    public JTextField getTxtForm() {
        ...
        if (type.equals("number")) {
            ...
            if (editor instanceof JSpinner.DefaultEditor spinnerEditor) {
                return spinnerEditor.getTextField();
            }
        }
        return null;
    }
    ...
    public void setSpinner(int min, int max, int step) {
        spinner.setModel(new SpinnerNumberModel(0, min, max, step));
    }
